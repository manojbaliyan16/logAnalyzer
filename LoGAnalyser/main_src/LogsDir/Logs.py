...
class Logs:
    ...
    def getLogs(self):
        ...
        for attachment in attachmentPaths:
            ...
            elif(attachment.find("downloadPipe")):
                attachedList.append(attachment)
        if(attachedziplist!=[]):            
            DownloadedZipsFolderPath=self.tkt_folder_path+"Downloaded_ZIPS\\"
        ...
        if(attachedproList!=[]):
            ...
            if(validPros!=[]):
                ...
                DirectProsFolderPath=self.tkt_folder_path+"\\DirectPro_LOGS"
        ...
        if(attachedbinList!=[]):
            ...
            if((self.TRC_Path!="Undetermined")and(self.TRC_Path!="Empty")):               
                DecodedLogsFolderPath=self.tkt_folder_path+"\\Decoded_LOGS"
    ...
    def changeExtension(self,attachedbinList,extension_toChange):
        ...
        for attachedbin in attachedbinList:
            ...
            if(binfile.endswith(".bin")):
                ...
                changedProLocationpath=binlocation+"\\"+changedProName
